...
public class PresetImageServiceImpl implements PresetImageService {
	...
	public Object findProcedure(long id) {
		return presetImageDao.findProcedure(id);
	}

	public List<Object> findPresets(int pageSize, int startRow, String jcStype,	String proName) {
		return presetImageDao.findPresets(pageSize, startRow, jcStype, proName);
	}

	public int findPresetsCount(String jcType, String proName) {
		return presetImageDao.findPresetsCount(jcType, proName);
	}
