...
public class DeviceServiceImpl implements DeviceService{
	...
	public List<DevicesInfo> findDevicesInfoPage(int pageSize, int startRow,Integer deviceStatus,
			Long teamId,String receiverName,String deviceCode,Long areaId){
		return deviceDao.findDevicesInfoPage(pageSize, startRow, deviceStatus, 
				teamId, receiverName, deviceCode, areaId);
	}
	
	public int getDevicesInfoCount(Integer deviceStatus,
			Long teamId,String receiverName,String deviceCode,Long areaId){
		return deviceDao.getDevicesInfoCount(deviceStatus,teamId,receiverName,deviceCode,areaId);
	}
