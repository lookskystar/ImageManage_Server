...
public class DeviceDaoImpl extends AbstractDao implements DeviceDao{
	...
	@SuppressWarnings("unchecked")
	public List<DevicesInfo> findDevicesInfoPage(int pageSize, int startRow,Integer deviceStatus,
			Long teamId,String receiverName,String deviceCode,Long areaId){
		StringBuilder builder=new StringBuilder();
		builder.append("from DevicesInfo r where 1=1");
		if(deviceStatus!=null&&!deviceStatus.equals("")){
			builder.append(" and r.deviceStatus = "+deviceStatus);
		}
		if(teamId!=null&&!teamId.equals("")){
			builder.append(" and r.teamId = "+teamId);
		}
		
		if(receiverName!=null&&!receiverName.equals("")){
			builder.append(" and r.receiverName like '%"+receiverName+"%'");
		}
		if(deviceCode!=null&&!deviceCode.equals("")){
			builder.append(" and r.deviceCode like '%"+deviceCode+"%'");
		}
		if(areaId!=null&&!areaId.equals("")){
			builder.append(" and r.areaId ="+areaId);
		}
		builder.append("  order by r.deviceCode asc,r.deviceStatus asc ,r.returnTime desc,r.devicesId asc");
	...
	public int getDevicesInfoCount(Integer deviceStatus,
			Long teamId,String receiverName,String deviceCode,Long areaId){
		StringBuilder builder=new StringBuilder();
		builder.append("select count(r.devicesId) from DevicesInfo r where 1=1");
		if(deviceStatus!=null&&!deviceStatus.equals("")){
			builder.append(" and r.deviceStatus = "+deviceStatus);
		}
		if(teamId!=null&&!teamId.equals("")){
