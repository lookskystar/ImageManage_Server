...
public class QueryAction {
	...
	public String ajaxAddJSONData()throws Exception{
		...
		//String jsonStr="[{'pro_rank':'0007','jc_num':'2065','pro_num':'11','area_id':1,'server_url':'/20110101/81138/64501301/123456.AVI','video_time':0.0,'take_time':'2014-03-11 12:06:35','local_url':'F:\\test\\120618.JPG','type':0,'take_gh':'80981'}]";
		JSONObject jsonObject=null;
		...
		for(int i=0;i<jsonArray.length();i++){
			...
			map=queryService.findMapData(gonghao, proNum, jcnum);
			count=queryService.findUrlNum(server_url);
			try{
			   if(count!=null&&count==0){
					Integer takeId=Integer.parseInt(map.get("take_id"));
					String takeTime=jsonObject.optString("take_time");
					Integer areaId=jsonObject.optInt("area_id",0);
					Long proId=Long.parseLong(map.get("pro_id"));
