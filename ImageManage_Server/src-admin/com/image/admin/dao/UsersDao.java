...
public interface UsersDao {
	 ...
	 * @return
	 */
	public List<DictUsers> findDictUsersPage(int pageSize, int startRow,Long areaId,String name,String gonghao,Long teamId);
	
	/**
	 * 得到总记录数
	 * @return
	 */
	public int getDictUsersCount(Long areaId,String name,String gonghao,Long teamId);
