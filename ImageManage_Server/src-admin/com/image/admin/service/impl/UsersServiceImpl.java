...
public class UsersServiceImpl implements UsersService {
	...
	public PageModel<DictUsers> findDictUsers(Long areaId, String name,String gonghao,
			Long teamId) {
		return usersDao.findDictUsers(areaId, name,gonghao, teamId);
	}
	...
	public List<DictUsers> findDictUsersPage(int pageSize, int startRow,
			Long areaId, String name, String gonghao, Long teamId) {
		return usersDao.findDictUsersPage(pageSize, startRow, areaId, name, gonghao, teamId);
	}

	public int getDictUsersCount(Long areaId, String name, String gonghao,
			Long teamId) {
		return usersDao.getDictUsersCount(areaId, name, gonghao, teamId);
	}
