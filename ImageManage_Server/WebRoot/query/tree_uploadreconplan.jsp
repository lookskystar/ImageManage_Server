 	...
 	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="overflow: auto;">
 		<tr>
 			<td class="ver01" width="20%">
				<div class="box1"  panelHeight="500" overflow="auto" showStatus="false">
			...
			<td valign="top">
				<iframe scrolling="auto" width="100%" frameBorder=0 id="imageIframe" name="imageIframe" onload="iframeHeight('imageIframe')" src="<%=basePath%>queryAction!queryUploadRecOnPlan.do?jcRecId=${jcRecId }"  allowTransparency="true"/>
			</td>
		</tr>
	</table>
</body>
