...
<div id="scrollContent">
   	<div class="box1"  panelHeight="550" overflow="auto">
		<table class="tableStyle">
		  	...
		  	<c:forEach items="${uploadRecListOnPlan }" var="rec" varStatus="s">
					<tr align="center">
						...
						<td>${rec.proRank }</td>
						<td>${rec.takeName }</td>
						<td>照片数量：${rec.imageNumStd }<br/>视频时长：${rec.videoTimeStd }分钟<br/></td>
						...
						<td><a href="<%=basePath%>queryAction!queryTakeDetailRecOnProec.do?proecId=${rec.proecId }&workId=${rec.workId }&jcRecId=${jcRecId}" style="color:blue;">查看详情</a></td>
					 </tr>
			 </c:forEach>
