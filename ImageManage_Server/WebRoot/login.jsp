...
<body >
	<div class="login_main">
		<div class="login_top">
			...
			<div align="right" style="padding-top: 5px;"><a href="<%=basePath%>/soft/setup.exe" style="color: red;font-size: 14px;">图像识别管理系统客户端下载 </a></div>
		</div>
		...
		<div class="login_bottom">
			<div class="login_copyright">广州铁路(集团)公司 COPYRIGHT 2013 </div>
		</div>
	</div>
	<!-- 
